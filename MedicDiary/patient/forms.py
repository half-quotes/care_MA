...
class PatientProfileForm(forms.ModelForm):
    class Meta:
        ...
        fields = ('name','age','gender','address','city','phone','emergency_contact','profession','race','profile_pic','Aadhar_Number','healthcare_coverage','healthcare_expenses','life_span','county')
