...
class PatientProfile(models.Model):
    ...
    healthcare_coverage = models.IntegerField(blank=True, default=0.00)
    healthcare_expenses = models.IntegerField(blank = True, default=0.00)
    county = models.CharField(max_length=30, blank = True, default='null')
    life_span = models.IntegerField(blank = True, default=0.00)
